...
lib.ssMetadata = [
		{name:"Mario_atlas_1", frames: [[0,0,700,400],[366,477,58,59],[433,402,59,59],[426,524,58,59],[433,463,59,59],[0,538,58,59],[60,538,58,59],[0,477,59,59],[120,538,58,59],[61,477,59,59],[180,538,58,59],[240,538,58,59],[122,477,59,59],[300,538,58,59],[183,477,59,59],[360,538,58,59],[486,524,58,59],[244,477,59,59],[494,402,58,59],[305,477,59,59],[494,463,58,59],[546,524,36,48],[0,402,431,73],[420,585,24,32],[554,470,28,30],[554,436,32,32],[554,402,34,32],[546,574,26,32]]}
];
...
if (reversed == null) { reversed = false; }
	...
	props.labels = {normal:0,run:1,end:9};
	props.loop = loop;
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance}]}).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_2}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_4}]},1).to({state:[{t:this.instance_3}]},1).to({state:[{t:this.instance_2}]},1).to({state:[{t:this.instance_1}]},1).to({state:[{t:this.instance_5}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_7}]},1).to({state:[{t:this.instance_8}]},1).to({state:[{t:this.instance_9}]},1).to({state:[{t:this.instance_10}]},1).to({state:[{t:this.instance_11}]},1).to({state:[{t:this.instance_12}]},1).to({state:[{t:this.instance_13}]},1).to({state:[{t:this.instance_14}]},1).to({state:[{t:this.instance_15}]},1).to({state:[{t:this.instance_16}]},1).to({state:[{t:this.instance_17}]},1).to({state:[{t:this.instance_18}]},1).to({state:[{t:this.instance_19}]},1).to({state:[{t:this.instance_20}]},1).to({state:[{t:this.instance_21}]},1).to({state:[{t:this.instance_22}]},1).to({state:[{t:this.instance_23}]},1).to({state:[{t:this.instance_24}]},1).to({state:[]},1).wait(1));
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-350,-28.45,1.6242,0.7793);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.footer_1, new cjs.Rectangle(-350,-28.4,700.1,56.9), null);
...
// stage content:
(lib.Mario = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance.setTransform(350,383.45);
...
p.nominalBounds = new cjs.Rectangle(350,200,350.1,211.89999999999998);
// library properties:
lib.properties = {
	id: '5714A3E8F8A840F5B801E72F20D0C0E9',
	width: 700,
	height: 400,
	fps: 24,
	color: "#FFFFFF",
	opacity: 1.00,
	manifest: [
		{src:"images/Mario_atlas_1.png?1594223300023", id:"Mario_atlas_1"}
	],
	preloads: []
};
...
an.compositions['5714A3E8F8A840F5B801E72F20D0C0E9'] = {
